...
class CrackEgg extends StatefulWidget {
  const CrackEgg({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _CrackEggGameState createState() => _CrackEggGameState();
}

class _CrackEggGameState extends State<CrackEgg> {
  int _score = 0;
